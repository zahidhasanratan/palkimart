						...
						<div class="order-history">
                         ...
                         <form id="userform" class="form-horizontal" action="{{route('user-wwt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                      <select class="form-control" name="methods" id="withmethod" required>
                                            ...
                                            <option value="use for shopping">use for shopping</option>
                                            <option value="Other Mobile payment">Other Mobile payment</option>
                                ...
                                <div id="paypal"  style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-12" for="name">Enter Mobile Acc Number*

                                        </label>
                                        <div class="col-sm-12">
                                            <input name="acc_email" placeholder="Enter Mobile Acc Number" class="form-control" value="{{ old('email') }}" type="tel">
                                        </div>
                                    </div>
                                ...
                                <strong>{{ $langg->lang351 }} {{ $sign->sign }}{{ $gs->withdraw_fee }} {{ $langg->lang352 }} {{ $gs->withdraw_charge }}% {{ $langg->lang353 }}</strong>
                                            ...
                                            <br/>
                                            <div> <h4>  Please contact support : 01771 088 100</h4>
                                            <h5>  Min. 500 & Max. 2000 taka allowed for a month.</h5> 
                                            <h6>The payment will provide max. 7-10 business days </h6>
                                            <h6>authority has preserved all rights regarding this </h6>
                                            </div>
                                        </form>
