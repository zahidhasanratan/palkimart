                        ...
                        <div class="content-area">
                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div id="paypal" style="display: none;">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-sm-12" for="name">Enter Bkash number *

                                        </label>
                                        <div class="col-sm-12">
                                            <input name="acc_email" placeholder="Enter Bkash number" class="form-control" value="{{ old('email') }}" type="tel">
                                        </div>
                                    </div>
